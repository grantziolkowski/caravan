...
#Demo Trips
dt1 =   Trip.create(origin_address: nyaddress1, destination_address: da1, driver_id: 1, leaving_at: '9/8/2015', arriving_at: '13/8/2015', available_volume: 50, max_weight: 5, rate: 7.50 , content_restrictions: 'No flammables', vehicle: "U-Haul Lambos")
...
dt6 = Trip.create(origin_address: nyaddress1, destination_address: sf1, driver_id: 6, leaving_at: "2015-08-19 18:36:59 -0400", arriving_at: Faker::Date.forward(10), available_volume: rand(10..400), max_weight: rand(1..200), rate: 0.50 , content_restrictions: "No food", vehicle: "F-150")

dt7 = Trip.create(origin_address: nyaddress2, destination_address: sf2, driver_id: 2, leaving_at: "2015-08-20 18:36:59 -0400", arriving_at: "2015-08-24 18:36:59 -0400", available_volume: rand(10..400), max_weight: rand(1..200), rate:9.20 , content_restrictions: "Not responsible for lost or stolen items", vehicle: "Truck")

dt9 = Trip.create(origin_address: nyaddress4, destination_address: sf4, driver_id: 8, leaving_at: "2015-08-22 18:36:59 -0400", arriving_at: "2015-08-24 18:36:59 -0400", available_volume: rand(10..400), max_weight: 45, rate: 0.50 , content_restrictions: "Passengers Welcome", vehicle: "Sprinter")

dt10 = Trip.create(origin_address: nyaddress5, destination_address: sf5, driver_id: 5, leaving_at: "2015-08-19 18:36:59 -0400", arriving_at: "2015-08-24 18:36:59 -0400", available_volume: 45, max_weight: 120, rate: 1.20, content_restrictions: "Passengers Welcome", vehicle: "Minivan")

dt11 = Trip.create(origin_address: nyaddress1, destination_address: sf6, driver_id: 6, leaving_at: "2015-08-19 18:36:59 -0400", arriving_at:  "2015-08-24 18:36:59 -0400", available_volume: 40, max_weight: 140, rate: 2.00 , content_restrictions: "Pets allowed", vehicle: "Minivan")

dt12 = Trip.create(origin_address: nyaddress2, destination_address: sf7, driver_id: 2, leaving_at: "2015-08-19 18:36:59 -0400", arriving_at:  "2015-08-23 18:36:59 -0400", available_volume: 25, max_weight: 80, rate: 0.99 , content_restrictions: "Pets allowed", vehicle: "U-Haul")

dt13 = Trip.create(origin_address: nyaddress3, destination_address: sf8, driver_id: 3, leaving_at: "2015-08-19 18:36:59 -0400", arriving_at:  "2015-08-23 18:36:59 -0400", available_volume: 30, max_weight: 110, rate: 1.00 , content_restrictions: "Cardboard parcels only", vehicle: "U-Haul")
